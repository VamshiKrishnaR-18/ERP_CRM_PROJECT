...
import { UserPlus, ShoppingCart, DollarSign, Package, Mail, Calendar } from "lucide-react";
  ...
  return (
    <Card className="bg-zinc-900 border-zinc-800">
      <CardHeader>
        ...
        <CardDescription className="text-zinc-500">Latest updates from your business</CardDescription>
      </CardHeader>
      <CardContent>
