    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <Card className="bg-zinc-900 border-zinc-800 col-span-1 lg:col-span-2">
        <CardHeader>
          ...
          <CardDescription className="text-zinc-500">Monthly revenue and order trends</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        <CardHeader>
          ...
          <CardDescription className="text-zinc-500">Top performing categories</CardDescription>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={categoryData}>
              <CartesianGrid strokeDasharray="3 3" stroke="#3f3f46" />
              <XAxis dataKey="category" stroke="#71717a" angle={-45} textAnchor="end" height={100} />
              <YAxis stroke="#71717a" />
              <Tooltip 
                contentStyle={{ 
                  backgroundColor: '#18181b', 
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        <CardHeader>
          ...
          <CardDescription className="text-zinc-500">New customers over time</CardDescription>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
